...
</header>    <div id="careers">
        <div id="banner_small">
        </div>
        <div id="main">
            <div class="container">
                    <div class="title">
                        <h1 class="main_title">CAREERS</h1><hr>
                        <div class="clear"></div>
                    </div>
                <h1>NOW ACCEPTING RESUMES & COVER LETTERS FOR FRONT OF HOUSE, BACK OF HOUSE AND MANAGERIAL STAFF!</h1>
                <h2>Please email resume & cover letter to:<br>
                <a href="mailto:careers@enjoybrokenrice.com">careers@enjoybrokenrice.com</a></h2>
                <hr class="hr_margin">
            </div>
        </div>
