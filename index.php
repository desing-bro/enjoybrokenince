...
<header>
	...
	<div id="banner_logo">
    	<center><img src="images/logo_large.png"></center>
    </div>
</div>

<div id="main">
	<div class="container">
        <h1>BROKEN RICE IS A FAST-CASUAL RESTAURANT SERVING TRADITIONAL ASIAN STREET-FOOD WITH A MODERN FEEL.</h1>
        <p>Offering contemporary takes on classic staples from Vietnam, Thailand, China, and elsewhere in Asia. It is our belief that real fresh ingredients, both locally sourced and mindfully prepared, are the keys to providing intensely flavorful &amp; healthy food.</p>
    </div>
</div>

<div id="main_order_online">
	<div class="container">
        <div class="buttons">
            <a href="Broken_Rice_Menu.pdf" target="_blank">
                <div class="button">
                    See The Menu
                </div>
			</a>
            <a href="http://www.grubhub.com/r/w/47828/restaurant/351948" target="_blank">
...
<!--<div id="main_photo_01">
</div>-->


 <div id="main">
 <div id="main_location_title">
    	<h1 class="title">
        	FIND A BROKEN RICE NEAR YOU
        </h1>
    </div>
            <div class="container_left">
            	<div class="container">
                    <div class="title">
                        <h1 class="main_title">LOCATIONS</h1><hr>
                        <div class="clear"></div>
                    </div>
                    <p>1390 S Colorado Blvd.<br> Denver, CO 80222</p>
					<p>T: 720.399.6698<!--<br>F: 123.456.7890</p>
					<p>open daily | 9:00AM - 10:00PM</p>-->
                    <p>Sun - Thu: 11:00am - 9:00pm<br>Fri - Sat: 11:00am - 10:00pm</p>
                    <div class="buttons">
                        <a href="Broken_Rice_Menu.pdf" target="_blank">
                            <div class="button">
                                See The Menu
          ...
          <div class="container_right">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3070.146359822844!2d-104.942219384626!3d39.691413079456034!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x876c7e7635517ccb%3A0x6c07b2a0b8b348db!2s1390+S+Colorado+Blvd%2C+Denver%2C+CO+80222!5e0!3m2!1sen!2sus!4v1480374467374" width="100%" height="100%" frameborder="0" style="border:0; min-height: 400px;" allowfullscreen ></iframe>
            </div>
            <div class="clear"></div>
		</div>
